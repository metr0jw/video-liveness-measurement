...
df_m12.to_csv("itzy_m12.csv", mode='w', header=False)
df_s12.to_csv("itzy_s12.csv", mode='w', header=False)
df_m23.to_csv("itzy_m23.csv", mode='w', header=False)
df_s23.to_csv("itzy_s23.csv", mode='w', header=False)
df_m13.to_csv("itzy_m13.csv", mode='w', header=False)
df_s13.to_csv("itzy_s13.csv", mode='w', header=False)