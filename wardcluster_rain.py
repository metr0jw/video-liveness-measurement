...
data = pd.read_csv("data_rain.csv")
...
plt.legend()
plt.savefig('data_rain.png', bbox_inches='tight')
plt.plot(y_predict_scaled, ls="-.", label="Cluster")
plt.legend()
plt.savefig('prediction_rain.png', bbox_inches='tight')
pd.DataFrame(y_predict_scaled).to_csv("y_prediction_rain.csv")